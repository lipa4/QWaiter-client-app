 ...
 */
package com.tvz.tomislav.qwaiter.qrcode;
...
import com.tvz.tomislav.qwaiter.qrcode.ui.camera.CameraSource;
import com.tvz.tomislav.qwaiter.qrcode.ui.camera.CameraSourcePreview;

import com.tvz.tomislav.qwaiter.qrcode.ui.camera.GraphicOverlay;
...
public final class BarcodeCaptureActivity extends AppCompatActivity implements QRCodeDetectedInterface {
    ...
    public void onQRCodeDetected() {
        ...
        if (graphic != null) {
            ...
            setResult(RESULT_CANCELED);
            Toast.makeText(this,"No barcode detected!",Toast.LENGTH_SHORT);
